	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(./assests/Login_v15/images/bg-01.jpg);">
					<span class="login100-form-title-1">
						ĐĂNG NHẬP HỆ THỐNG
					</span>
				</div>

				<form class="login100-form validate-form" @submit.prevent="handelLogin">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Tên đăng nhập không được để trống!">
						<span class="label-input100">Tài khoản</span>
						<input class="input100" type="text" name="username" placeholder="Tài khoản" v-model="username">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate="Mật khẩu không được để trống!">
						<span class="label-input100">Mật khẩu</span>
						<input class="input100" type="password" name="pass" placeholder="Mật khẩu" v-model="password">
						<span class="focus-input100"></span>
					</div>
		...
		async handelLogin() {
			const res = await axios.post(`auth/sign-in`, {
				...
				.then(res => {
					...
					var role = [];
					res.data.roles.forEach(s => {
						role.push(s.authority);
					});
